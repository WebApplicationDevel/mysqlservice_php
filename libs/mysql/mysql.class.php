...
class mysql {
    ...
    /**
     * 构造函数 
     * @param type $db_host 数据库服务器
     * @param type $db_user 用户名
     * @param type $db_pwd 密码
     * @param type $db_database 数据库名称
     * @param type $conn 连接
     ...
     * 查询记录
     * @param type $sql sql
     * @param type $type 查询类型,one--单记录，all--所有记录
     * @return type
     */
